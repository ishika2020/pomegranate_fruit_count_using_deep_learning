...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("pomegranate", 1, "pomegranate")
        ...
        for a in annotations:
            ...
            self.add_image(
                "pomegranate",  ## for a single class just add the name here
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "pomegranate":
